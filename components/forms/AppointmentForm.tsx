...
export const AppointmentForm = ({
  ...
  const onSubmit = async (
    ...
    try {
      if (type === "create" && patientId) {
        ...
        if (!appointment?.$id) {
          console.error("Brak appointmentId – nie można zaktualizować wizyty.");
          setIsLoading(false);
          return;
        }
  ...
  switch (type) {
    case "cancel":
      ...
      break;
    case "schedule":
      buttonLabel = "Zaplanuj wizytę";
      break;
    default:
      buttonLabel = "Zatwierdź wizytę";
  }
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-6">
          ...
          <>
            ...
            >
              <CustomFormField
                ...
                name="reason"
                label="Powód wizyty"
                placeholder="Roczna kontrola zdrowia"
        ...
        {type === "cancel" && (
          <CustomFormField
            ...
            placeholder="Wyskoczyło pilne spotkanie"
          />
        )}
